...
# for model_name in ['ProbCBM']:
    acc_dict[model_name_dict[model_name]], concept_counts = run_intervene(logger, 12, 32, device='cuda:2', seed=42, model_name=model_name, model_filename='249.pth')
...
plt.title('AwA2 (85 concepts, 50 classes)',fontsize='xx-large')
